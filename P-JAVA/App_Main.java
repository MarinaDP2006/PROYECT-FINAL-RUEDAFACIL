...
public class App {
        ...
        do {
            ...
            switch (op) {
                ...
                case 4:
                    ...
                    System.out.println(encontrado != null ? "Cliente encontrado: " + encontrado.getNombre()
        ...
        do {
            ...
            switch (op) {
                case 1:
                    ...
                    sc.nextLine();
                    System.out.print("Estado (disponible/alquilado): ");
                ...
                case 2:
                    ...
                    System.out.println(encontradoV != null
                            ? "Matrícula: " + encontradoV.getMatricula() + ", Marca: " + encontradoV.getMarca()
                                    + ", Modelo: " + encontradoV.getModelo()
                            : "No encontrado");
                    break;
                case 3:
        ...
        do {
            ...
            switch (op) {
                case 1:
                    ...
                    a.setPrecioTotal(sc.nextDouble());
                    sc.nextLine();
                    ...
                    } catch (ClienteNoEncontradoException | VehiculoNoDisponibleException e) {
                ...
                case 5:
                    ...
                    grupo.forEach((dni, lista) -> System.out
                            .println("Cliente " + dni + ": " + lista.size() + " alquiler(es)"));
                    break;
                case 0:
                    break;
                default:
    ...
    private static void historialCliente() {
        ...
        if (lista.isEmpty())
            ...
            lista.forEach(a -> System.out.println("ID: " + a.getIdAlquiler() + " | Inicio: " + a.getFechaInicio()
                    + " | Estado: " + a.getEstadoContrato()));
    }
}
