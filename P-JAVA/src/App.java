...
public class App {
	public static void main(String[] args) throws ClienteNoEncontradoException {
		...
		int opcion;
		do {
			System.out.println("\n --- MENÚ PRINCIPAL DE RUEDAFACIL - ALQUILERES --- ");
	...
	private static void menuVehiculos() {
		...
		do {
			...
			case 2:
				...
				System.out.println(encontradoV != null ? "Matrícula: " + encontradoV.getMatricula() + ", Marca: " + encontradoV.getMarca() + ", Modelo: " + encontradoV.getModelo(): "No encontrado");
				break;
			case 3:
				System.out.println();
	...
	private static void menuAlquileres() throws ClienteNoEncontradoException {
		...
		do {
			...
			case 5:
				...
				grupo.forEach(
						(dni, lista) -> System.out.println("Cliente " + dni + ": " + lista.size() + " alquiler(es)"));
				break;
			case 0:
				break;
			default:
	...
	private static void historialCliente() {
		...
		if (lista.isEmpty()) // Si la lista esta vacia, es que no ha hecho ningun alquiler
